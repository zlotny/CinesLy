...
class Pelicula{
	...
	function registrarPelicula($pelicula)
	{
		...
		/*sintaxis correcta de un insert
INSERT INTO pelicula (idPelicula, titulo, director, distribuidora, duracion, sinopsis, actores, anho,
 fecha_estreno, genero, pais, votos, valoracion, tipo, cont_valoracion)
 VALUES ('4', 'asdfasdf' , '1' , '2' , '2' , '2' ,	'2' , '2' , '2014-12-17' , '2' , '7' , '6' , '5' , '4' , '3')*/
...
echo "<br>";
echo "pelicula de la base de datos";
echo "<br>";
...
echo "creado objeto pelicula <br>";


		if($pelicula->titulo!=""){
			echo "titulo modificado";

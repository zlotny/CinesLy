...
$sql=$sql = "\n"
    . "SELECT u.nombreUsuario,p.fecha,p.publica FROM agrega a, usuario u, publicacion p WHERE a.email2='".$this->email."' AND a.email1=u.email AND a.estado=0 AND u.email=p.email \n"
    . "UNION\n"
    . "SELECT u.nombreUsuario,p.fecha,p.publica FROM agrega a, usuario u, publicacion p WHERE a.email1='".$this->email."' AND a.email2=u.email AND a.estado=0 AND u.email=p.email \n"
    . "UNION\n"
    . "SELECT u.nombreUsuario,p.fecha,p.publica FROM usuario u,publicacion p WHERE u.email='".$this->email."' AND u.email=p.email ORDER BY 2 desc";

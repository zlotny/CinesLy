      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <form class="form-horizontal" role="form">
            ...
            <div class="form-group">
              <label for="nueva_contraseña" class="col-lg-3 control-label">Nueva Contraseña</label>
                <div class="col-lg-5">
            ...
            <div class="form-group">
              <label for="repita_contraseña" class="col-lg-3 control-label">Repetir Contraseña</label>
                <div class="col-lg-5">

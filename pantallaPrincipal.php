							...
							<div class="well">
								...
								<div class="clearfix">
									...
									if($_SESSION["usuario"]->email == $usuRow->email){
										...
										echo "<input type='button' onclick='mostrar(".$publicaciones[4][$i]."),ro(1".$publicaciones[4][$i].")' id='editar' class='btn btn-xs btn-primary pull-right little-right' value='Editar'/>";

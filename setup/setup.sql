...
CREATE USER 'usrCinesLy'@'localhost' IDENTIFIED BY  'AVVeY4MYU6bVXYhJ';

GRANT USAGE ON * . * TO  'usrCinesLy'@'localhost' IDENTIFIED BY  'AVVeY4MYU6bVXYhJ' WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0 ;
GRANT ALL PRIVILEGES ON  `CinesLy` . * TO  'usrCinesLy'@'localhost' WITH GRANT OPTION ;
